...
urlpatterns = [
   ...
   path('switch_ws/',change_ws,name='switch_ws'),
    ...
    path('toggle_ws_member_status/<str:custom_id>/<str:ws_id>', toggle_ws_member_status, name='toggle_ws_member_status'),
