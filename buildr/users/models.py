...
class issue(models.Model):
    ...
    priority = models.ForeignKey(priority,default=1, on_delete=models.SET_NULL, null=True, blank=True, related_name='issues')
    status = models.ForeignKey(status,default=1, on_delete=models.SET_NULL, null=True, blank=True, related_name='issues')
